...
###### For the sunburst fig, the innermost circle showes proportion of different divorce times, the middel circle shows the education level, and the outermost circle shows the major, whether it's STEM or not. As we can see, the never divorced group accounts for 58% of the total married people. For most of us, who are master of STEM students, stays in yellow-light orange part. So we probably end up with never divorce or divorce once(never divorce 0.5%, divorce once 0.27% and) .
