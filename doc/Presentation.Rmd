...
Income_sex_Divrate<- ggplot(Data_Income_Divrate_sex, aes(x = factor(Income), y = Div_rate, fill = SEX)) + 
                     ...
                     scale_fill_discrete(labels = c("Male", "Female"))
```
Income_sex_Divrate ![Click here!](https://github.com/TZstatsADS/Fall2016-proj1-grp8/blob/master/figs/Income%2C%20gender%20and%20divorce%20rate.png)
...
```
Income_age_Divrate ![Click here!](https://github.com/TZstatsADS/Fall2016-proj1-grp8/blob/master/figs/Income.%20agegroup%20and%20divorce%20rate.png)
