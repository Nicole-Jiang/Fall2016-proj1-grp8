...
###### This choropleth encodes divorce rates per 1000 population for successive 12-monthe period from 2008 with a quantize scale ranging from 0 to 11%. As we can see, the divorce rate is continuously decreasing for almost half decade in every states. However, the absolute value remains a high rate. 
...
# Minghao's Part
=======
```{r MinghaoDai's_Part, message=FALSE, warning=FALSE}
>>>>>>> Stashed changes
...
#One way to classficate income group.
...
#Another way to classficate income group.
...
##4 The different classification of income and different defination of divorce rate have no effect on the results. 
